...
namespace Kil0bitSystemMonitor.Helpers
{
    public static class SettingsLocalization
    {
        private static readonly Dictionary<string, string> TextToKey = new()
        {
            ...
            ["Value Alerts"] = "Settings.Appearance.ValueAlerts",
            ["Percentage metrics (CPU, RAM, GPU, Disk) use these thresholds and colors."] = "Settings.Appearance.ValueAlerts.Desc",
            ["Warning Threshold"] = "Settings.Appearance.WarningThreshold",
            ["Critical Threshold"] = "Settings.Appearance.CriticalThreshold",
            ["Warning Color"] = "Settings.Appearance.WarningColor",
            ["Critical Color"] = "Settings.Appearance.CriticalColor",
            ["Select Warning"] = "Settings.Appearance.SelectWarning",
            ["Select Critical"] = "Settings.Appearance.SelectCritical",
